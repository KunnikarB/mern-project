    ...
    <div className="p-6 relative min-h-[calc(100vh-128px)] flex flex-col items-center">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6 mb-6 flex items-center gap-4 w-full max-w-md">
        ...
        {started ? (
          <button
            onClick={handleStop}
            className="ml-4 bg-pink-400 text-white px-4 py-2 rounded-lg hover:bg-pink-600 cursor-pointer"
          >
            Stop
          </button>
        ) : (
          <button
            ...
            className="ml-4 bg-emerald-500 text-white px-4 py-2 rounded-lg hover:bg-emerald-400 cursor-pointer"
          >
            Start
          </button>
        )}
