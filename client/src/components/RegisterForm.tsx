  ...
  return (
    ...
    >
      {(['firstName', 'lastName', 'email'] as const).map((field) => (
        <div key={field}>
          ...
          <input
            ...
            className={`w-full p-2 rounded-md bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-400 ${
      ...
      <button
        type="submit"
        disabled={loading}
        className={`bg-violet-500 text-white rounded-xl px-4 py-2 font-medium hover:bg-violet-600 focus:outline-none focus:ring-2 focus:ring-pink-400 transition-colors ${
